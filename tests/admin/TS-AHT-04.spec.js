...
test.describe("Admin - Add Homestay", () => {
   ...
   * กรอกข้อมูลครบ
   */
  test("TC-AHT-04.1: Admin add homestay successfully", async ({
    page,
  }) => {
   ...
   * กรอกไม่ข้อมูลครบ
   */
  test("TC-AHT-04.2: Admin add homestay with incomplete data", async ({
    page,
  }) => {
    await goToPageHomestay(page);
   ...
   */
  test("TC-AHT-04.3: Admin cancel add homestay", async ({
    page,
  }) => {
    await goToPageHomestay(page);
  ...
  /**
   * TC-AHT-04.4
   * ยกเลิกการเพิ่มที่พัก
   */
  test("TC-AHT-04.4: Admin cancel add homestay", async ({
    page,
  }) => {
    await goToPageHomestay(page);
