...
test.describe("SuperAdmin - Search Package", () => {
   ...
   */
  test("TS-SPK-02.1: ค้นหาแพ็กเกจ", async ({ page }) => {
    await goToManagePackagePage(page);

    // ค้นหาแพ็กเกจด้วยคำว่า "ชม"
    const searchTerm = "ชม";
    await searchPackage(page, searchTerm);

    // ตรวจสอบว่าผลการค้นหาแสดงเฉพาะแพ็กเกจที่มีคำว่า "ชม"
