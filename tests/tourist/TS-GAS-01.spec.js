...
test.describe("TC-GAS-01 - ผู้ใช้งาน Tourist ดูรายละเอียดแพ็กเกจในหน้าจอรายละเอียดชุมชน", () => {
   ...
   */
  test("TC-GAS-01.1: ผู้ใช้งานล็อกอินเข้าสู่ระบบ", async ({ page }) => {
   ...
   */
  test("TC-GAS-01.2: ผู้ใช้งานไม่ได้ล็อกอินเข้าสู่ระบบ", async ({ page }) => {
...
//npx playwright test tests/tourist/TS-GAS-01.spec.js --headed
